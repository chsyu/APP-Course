  ...
  return (
    <Animated.View className="flex-1" style={screenStyle}>
      ...
      >
        ...
        <Animated.View className="mx-4 mb-6 rounded-xl overflow-hidden" style={surfaceStyle}>
          <View className="px-4 py-3">
            <ThemedText colorKey="textMuted" className="text-sm">
              上次從雲端更新
            </ThemedText>
            <ThemedText colorKey="textSecondary" className="text-sm mt-1">
              {lastSyncLabel}
            </ThemedText>
          </View>
        </Animated.View>
        ...
        <View className="mx-4">
          ...
          {!canSync ? (
            <ThemedText colorKey="textMuted" className="text-sm mt-3 text-center">
              登入後即可與雲端同步日記
            </ThemedText>
          ) : null}
        </View>
